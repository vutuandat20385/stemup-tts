  ...
  <body class="bg-body">
   ...
   <main class="container MT70">
	...
	<aside class="col-md-10 col-md-offset-1 help_content1">
		...
		<h4><b>I. Hướng dẫn sử dụng trên stemup.app</b></h4>
		...
		<img class="img-responsive" src="<?php echo base_url('images/image_HD/HDapp_home1.png') ?>" alt="">
		</div>
		
		<h4><b>II. Hướng dẫn sử dụng các tính năng trên stemup.app</b></h4>
		<h4><b>1. Xem danh sách bài được giao.</b></h4>
		...
		<p id="content_helpmobile"> Bước 3: Vào trang Hoạt đông đã làm để xem danh sách các bài đã làm rồi bao gồm: Người giao bài, thời gian làm bài, loại bài và sao thưởng từ phụ huynh.</p> 
		...
		<div class="help_mobile_dl col-md-12 col-sm-12 col-xs-12">
		<img class="img-responsive" src="<?php echo base_url('images/image_HD/HDapp_home2.png') ?>" alt="">
		</div>
		<div class="help_mobile_dl col-md-12 col-sm-12 col-xs-12">
		<img class="img-responsive" src="<?php echo base_url('images/image_HD/HDapp_home3.png') ?>" alt="">
		</div>
		...
		<div class="help_mobile_dl col-md-12 col-sm-12 col-xs-12">
		<img class="img-responsive" src="<?php echo base_url('images/image_HD/HDapp_home4.png') ?>" alt="">
		</div>
		<div class="help_mobile_dl col-md-12 col-sm-12 col-xs-12">
		<img class="img-responsive" src="<?php echo base_url('images/image_HD/HDapp_home5.png') ?>" alt="">
		</div>
		
		
		<h4><b>3. Xem kết quả</b></h4>
		...
		<div class="help_mobile_dl col-md-12 col-sm-12 col-xs-12">
		<img class="img-responsive" src="<?php echo base_url('images/image_HD/HDapp_home6.png') ?>" alt="">
		</div>
		<div class="help_mobile_dl col-md-12 col-sm-12 col-xs-12">
		<img class="img-responsive" src="<?php echo base_url('images/image_HD/HDapp_home7.png') ?>" alt="">
		</div> 
		...
		<h4><b>4. Làm câu hỏi trắc nghiệm và bài tập trên trang Tự Học.</b></h4>
		...
		<p id="content_helpmobile">Bước 2: Con nhấn vào biểu tượng <img class="img-responsive" src="<?php echo base_url('images/image_HD/HDapp_home8.png') ?>" alt="">  để tìm câu hỏi theo lĩnh vực quan tâm và nhấn chọn đáp án cho câu hỏi. Hệ thống sẽ gửi xác nhận kết quả.</p>
		<div class="help_mobile_dl col-md-12 col-sm-12 col-xs-12">
		<img class="img-responsive" src="<?php echo base_url('images/image_HD/HDapp_home9.png') ?>" alt="">
		</div>
		
		
		<p id="content_helpmobile"><b>- Làm bài tập trắc nghiệm vui do hệ thống cập nhật</b></p>
		<p id="content_helpmobile">Tại trang tự học con nhấn trang phần bài kiểm tra trong mục Hoạt động để làm bài kiểm tra. </p>
		<p id="content_helpmobile">Bước 1: Nhấn chọn mục Tự học.</p>
		<p id="content_helpmobile">Bước 2:Nhấn chọn bài trắc nghiệm để làm.</p>
		<p id="content_helpmobile">Bước 3: Làm bài trắc nghiệm như phần làm bài được giao. Con nhấn nộp bài và xem luôn đáp án chi tiêt do hệ thống cung cấp.</p>
		
		<div class="help_mobile_dl col-md-12 col-sm-12 col-xs-12">
		<img class="img-responsive" src="<?php echo base_url('images/image_HD/HDapp_home10.png') ?>" alt="">
		</div>
