		...
		?>	
			...
			<div class="form-group">
				...
				<select class="form-control" name="tinhthanh_id" id="tinhthanh_id" onchange="changeDataItem(event);">
					<?php
						foreach ($tinhthanh_list as $key => $val) {
					?>
						<option value="<?php echo $val['did'];?>" <?php if($result['tinhthanh_id']==$val['did']){ echo 'selected';}?>><?php echo $val['dataitem_name'];?></option>
					<?php
						}
					?>
				</select>
 			...
 			<div class="form-group">
 				...
 				<select class="form-control" name="quanhuyen_id" id="quanhuyen_id" onchange="changeDataItem(event);">
					<?php
						foreach ($quanhuyen_list as $key => $val) {
					?>
						<option value="<?php echo $val['did'];?>" <?php if($result['quanhuyen_id']==$val['did']){ echo 'selected';}?>><?php echo $val['dataitem_name'];?></option>
					<?php
						}
					?>
				</select>
 			...
 			<div class="form-group">
 				...
 				<select class="form-control" name="xaphuong_id" id="xaphuong_id" onchange="changeDataItem(event);">
					<?php
						foreach ($xaphuong_list as $key => $val) {
					?>
						<option value="<?php echo $val['did'];?>" <?php if($result['xaphuong_id']==$val['did']){ echo 'selected';}?>><?php echo $val['dataitem_name'];?></option>
					<?php
						}
					?>
				</select>
