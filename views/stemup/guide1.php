<aside class="col-md-12">
		<h3 class="text-center">HƯỚNG DẪN SỬ DỤNG ỨNG DỤNG STEMUP PHỤ HUYNH </h3>
		...
		<img class="img-responsive" style="width: 10%" src="<?php echo base_url('images/image_HDPH/HD7app_parent.png') ?>" alt="">
		...
		<div class="help_mobile_dl col-md-12 col-sm-12 col-xs-12">
			<img class="img-responsive" style="width: 25%" src="<?php echo base_url('images/image_HDPH/HD10app_parent.png') ?>" alt="">
		</div>
		...
		<div class="help_mobile_dl col-md-12 col-sm-12 col-xs-12">
			<img class="img-responsive" style="width: 40%" src="<?php echo base_url('images/image_HDPH/HD22app_parent.png') ?>" alt="">
		</div>
