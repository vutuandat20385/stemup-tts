					...
					<div id="thumbnail-preview-indicators" class="carousel slide" data-ride="carousel">
						<div class="carousel-inner">
							<div class="item slides active">
								<div class="slide-1" style="background-image: url(<?php echo $post['slide'][0]['avatar'] ?>);background-position: left !important;">
							...
							<div class="item slides">
								<div class="slide-3" style="background-image: url(<?php echo $post['slide'][1]['avatar'] ?>);background-position: left !important;">
									<div class="carousel-caption carousel-caption1">
