...
<h4 class="tle125">Tin liên quan</h4>
				<!-- <?php //echo 'Chưa có bài viết';?> -->
	<?php
		foreach ($common_news as $key => $value) {
	?>
		<div class="media-object-default mgin">
			<div class="media">
				<div class="media-left"><a href="<?php echo site_url('home/tintuc'.'/'.$value['url_name'])?>"><img class="media-object" src="<?php echo $value['avatar']?>" width="130" alt="placeholder image"></a></div>
