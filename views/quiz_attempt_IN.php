<!-- Template javascript -->
	  	<script src="<?php echo base_url('js/'.$quiz['quiz_template'].'.js');?>"></script>
	  	<?php 
...
<input type="radio" name="answer[<?php echo $qk;?>][]"  id="answer_value<?php echo $qk.'-'.$i;?>" value="<?php echo $option['oid'];?>"   <?php if(in_array($option['oid'],$save_ans)){ echo 'checked'; } ?>  >
		 ...
		 </td><td><div class="lang lang0"> <?php echo $option['q_option'];?></div> 
		 <div class="lang lang1"> <?php echo $option['q_option1'];?></div> 
		</td></tr></table>
