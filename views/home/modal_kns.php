					...
					<div class="modal-body" >
						  ...
						  <input type="text" style="display:none" id="id_sn" name="id_sn" value="0"/>
						   <input type="text" style="display:none" id="opt_choice_sn" name="opt_choice_sn" value=""/>
							...
							<div id="captcha" style="display:none;"><div class="g-recaptcha" data-sitekey="6Ldj3loUAAAAALRDbMvyYMULsJwbIWOeDSDQgaEv"></div></div>
											...
											$.ajax({
												...
												success: function(data){
													...
													if(data==1){
														...
														window.location.href= "<?php echo site_url('quiz/validate_quiz/')?>"+"/"+quid_global;
													}else{
			 ...
			 <div class="modal-content">
				...
				<div class="modal-body">
					<form class="resetpwd" method="post" action="<?php echo site_url('home/resetpassword');?>">
						...
						<div class="g-recaptcha" data-sitekey="6Ldj3loUAAAAALRDbMvyYMULsJwbIWOeDSDQgaEv" style="padding-top:50px; margin-left:0%"></div>
