...
<head>
  ...
  <!-- Morris chart -->
  <link rel="stylesheet" href="<?php echo base_url('sadmin/bower_components/morris.js/morris.css')?>">
  <!-- jvectormap -->
  ...
  <!--  <script src="<?php echo base_url('js/stemup_sendemail.js') ?>"></script> -->
  ...
  <link rel="stylesheet" href="<?php echo base_url('css/style-hu.css') ?>">
