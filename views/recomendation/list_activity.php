    ...
    <section class="row">
        ...
        <aside class="col-md-10" >
            <div class="box-lop" id="bannerpage">
                <div class="line-L">
                    <h1>Danh sách hoạt động của <?php echo $username; ?> theo chủ đề</h1>
<!--                    <a class="xem" href="--><?php //echo site_url('recomendation/list_activity_class') ?><!--">Xem theo Lớp</a>-->
                </div>
            </div>
            <ul class="nav nav-tabs">
                ...
                ?>
                        <li><a data-toggle="tab" href="#<?php echo $value['cid']?>"><?php echo $value['category_name']?>(<?php echo $value['count_cid']?>)</a></li>
                <?php
                    }
                ?>
            ...
            <div class="tab-content">
                <?php
                    ...
                    foreach ($catagory_by_id as $value){
                ?>
                <div id="<?php echo $value['cid'];?>" class="tab-pane fade in">
                    <h3><?php echo $value['category_name']?></h3>
                    <div class="cover activity_item ">

                    <?php
//                        echo '<pre>';
//                            print_r($comment_test[$ii]);
//                        echo '</pre>';
