...
<nav class="navbar navbar-stem navbar-fixed-top">
  <div class="container">
		...
		<ul id="grmncl" class="panel-collapse collapse">
				<a href="#" class="list-group-item close_menu_mb" style="float:right; z-index:100"> x</a>
				<a href="<?php echo site_url('home_user/manage_group') ?>" class="list-group-item" onclick="manageGroup(event);">
...
<main class="container MT70">
 ...
 <div class="box-bor MB20 visible-xs-block">
				  ...
				  <div role="tabpanel" class="tab-pane fade in active" id="home2a">
					<div class="box-bor MB20">
						...
						<!--	<li role="presentation" class="dropdown"><a href="#" id="tabDropOne1" class="dropdown-toggle" data-toggle="dropdown" role="tab" aria-controls="tab3" aria-haspopup="true" aria-expanded="false">Giao bài<span class="caret"></span></a>
							...
							<form method="GET" action="<?php echo site_url("library/video") ?>">
							<div class="input-group mb-2 mr-sm-2 mb-sm-0" style="padding-top:5px;padding-bottom:5px;width:45%;float:right">
						<!--	<input type="text" class="form-control input-txtSearchVideo" name="txtSearchVideo" value="<?php echo $search ?>" style="width:250px; margin-right:5px">
								<i class="pointer fas fa-search input-iconSearch" style="margin-top:10px" ></i> -->
								<input type="text" class="input-txtSearchVideo form-control" name="txtSearchVideo" value="<?php echo $search ?>">
								<i class="pointer fas fa-search input-iconSearch"></i>
							</div>
							</form>
						  <div id="tabContent1" class="tab-content">
							<div role="tabpanel" class="tab-pane fade in active" id="home1">
								        ...
								        <?php foreach($video_list as $vid){?>
										 <div class="box-bor" style="margin-bottom:20px">
										 <?php if($su == 1){
											 ?>
											...
											<ul class="dropdown-menu dropdown-left-manual" aria-labelledby="dropdownMenu1">
												<li><a href="<?php echo site_url('library/edit_video/'.$vid['lib_id']) ?>">Chỉnh sửa bài</a></li>
											...
											<?php } else {?>
												<div class="video-container" id="video-if-<?php echo $vid['lib_id'] ?>"> 
													<?php echo $vid['content'] ?>
												</div>
											<?php } ?>
											
											<center>
												<h4><i><?php echo $vid['description'] ?></i></h4>
												<?php if($su==1|| $su==3 || $su==6){ ?>
													<p><input type="button" class="btn btn-success" value="Tạo câu hỏi" onclick="create_question_video(<?php echo$vid['lib_id'] ?>)"></p>
												<?php } ?>
											</center>		
										 </div>
										<?php }?>
										 ...
										 <ul class="pagination listpage pagequiz">
											 ...
											 <?php if($numpage<11){ ?>
												...
												<li class="page-item <?php if($k+1==$page){?> active <?php } ?>"><a class="page-link" href="<?php echo site_url('library/video/'.($k+1).'?txtSearchVideo='.$search)?>"><?php echo  $k+1 ?></a></li>
												 <?php }?> 
										  <?php }else{?>
										  
											
												 <li class="page-item <?php if($page==1){?> active <?php } ?>"><a class="page-link" href="<?php echo site_url('library/video/1?txtSearchVideo='.$search)?>">1</a></li>
												  <?php if($pstart>2){ ?> 
													  <li class="page-item"><a class="page-link"> ... </a></li>
												  <?php } ?>
												<?php for($k=$pstart; $k<$pstart+7; $k++){?> 
												   <li class="page-item <?php if($k==$page){?> active <?php } ?> "><a class="page-link" href="<?php echo site_url('library/video/'.$k.'?txtSearchVideo='.$search)?>"><?php echo  $k ?></a></li>
												<?php }?> 
												<?php if($pstart+7<$numpage){ ?> 
													  <li class="page-item"><a class="page-link"> ... </a></li>
												  <?php } ?>
												 <li class="page-item <?php if($page==$numpage){?> active <?php } ?>"><a class="page-link" href="<?php echo site_url('library/video/'.$numpage.'?txtSearchVideo='.$search)?>"><?php echo  $numpage ?></a></li>
											 <?php }?>
	...
	function deleteVideo(idvideo){
		if(confirm("Bạn có chắc muốn xáo Video này không?")){
			window.location.href = site_url+"/library/deleteVideo/"+idvideo;
		}else{
		}
	}
	</script>
