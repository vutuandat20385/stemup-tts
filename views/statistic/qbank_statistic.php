        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">BẢNG TỔNG HỢP</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
			  ...
			  <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
				...
				<?php 
					$i = 2;
					foreach ($level_list as $ll) {
						$i++;
						if($i != 16 && $i != 17 && $i != 18){
							?>
							<th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending"><?php echo $ll['level_name'] ?></th>
							<?php
						}
					}
				?>
					...
					foreach($cid_list as $cid){
						?>
							<tr role="row" class="odd">
								<td><?php echo $cid['abbr'] ?></td>
								<?php foreach ($level_list as $lid){
										?>
									<!--	<td><?php echo $cid['cid'].' '.$lid['lid'] ?></td> -->
										<td> <?php echo $this->sadmin_model->count_lid_cid($cid['cid'],$lid['lid']) ?> </td> 
										<?php
								} ?>
							</tr>
						<?php
