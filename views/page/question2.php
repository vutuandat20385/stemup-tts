...
<meta property="og:type" content="website" />
	...
	<?php if($opt_choice==1||$opt_choice==2||$opt_choice==3||$opt_choice==4){?>
		<script>
		var answ="<?php echo $opt_choice?>";
		var qid1="<?php echo $mcq['qid']?>";
		</script>
		<script src="<?php echo base_url('js/answer_before_login.js');?>"></script>
	<?php }?>
	<script>
			  ...
			  <div class="row1 col-xs-12" style="margin-top:20px">
			    ...
			    <div class="col-xs-12" style="margin-bottom:10px">
				     <?php if(strpos($mcq['question'],'latex.codecogs.com')!==false || strpos($mcq['question'],'www.w3.org/1998/Math/MathML')!==false){?>
					  ...
					  <?php if($created_user['su']==3 && $created_user['text_license'] && $mcq['show_logo']==1) {?>
							<div class="imgwlogo" style="margin-top:-15px">
									<a href="<?php echo $created_user['out_link']?>" target="_blank"> 
										<div class="logobanner">
											...
											<div >
												...
												<table style="width:100%">
												  ...
												  <?php if($created_user['logo']){?>
												  <div class="logoimg">
														<img src="<?php echo $created_user['logo'] ?>">
												  </div>
												  <?php }?>
												  </td>
												   <td class="textorg" >
												     <div  class="contentbn">
														<i style="font-weight:200px">Cung cấp bởi</i> <b><a><?php echo $created_user['text_license'] ?></b></a>
													 </div>
												   </td>
					   ...
					   <?php } else{?>
						 ...
						 <div class="mcq_multimd  assqid-<?php echo $mcq['qid']?>">
							 ...
							 <?php 
							 if($created_user['su']==3 && $created_user['text_license'] && $mcq['show_logo']==1) {?>
								<div class="imgwlogo">
									<a>
					  ...
					  <div class="row">
						  <div class="col-xs-12" style="margin-bottom:5px">
							  <ul class="list-inline text-bt">
								  <?php if($mcq['liked']==1){?>
								  <li class="col-xs-3"><a class="acti pointer" 
								  <?php if($login==1){?>
								  onclick="like_question(this , <?php echo $mcq['qid'] ?>)"
								  <?php }else{?>
								  onclick="popup_require_login()"
								   <?php }?>
								  ><i class="fas fa-thumbs-up mr-5"></i><span class="hidden-xs">Thích</span></a></li>
								  <?php } else{?>
								  <li class="col-xs-3"><a class="pointer"  
								  <?php if($login==1){?>
								  onclick="like_question(this , <?php echo $mcq['qid'] ?>)"
								  <?php }else{?>
								  onclick="popup_require_login()"
								  ...
								  <li class="col-xs-3"><a class="pointer" 
								  <?php if($login==1){?>
								   data-toggle="collapse" data-target="#comment_area_main_<?php echo $mcq['qid']?>"
								  <?php }else{?>
								  onclick="popup_require_login()"
								   <?php }?>
								  ><i class="far fa-comment-alt mr-5"></i><span class="hidden-xs">Bình luận</span></a></li>
									...
									<li class="col-xs-3">
										<a class="assign-bt pointer" href="<?php echo site_url('page/question/'.$mcq['permalink'])?>"><i class="fab fa-resolving mr-5"></i><span class="hidden-xs">Đáp án</span></a>
									</li>
							  </ul>
						  </div>
						   <!-- Single button 
...
caret caret_e "></span>
	   ...
	   <div class="col-md-4  mb-10">
			<a  class="pointer" href="<?php echo site_url('page/question/'.$rqt['permalink'].'/notsolved')?>">
	   ...
	   <div class="box-bor MB20">
		  ...
		  <?php foreach($quiz_fun_rb as $qz){?>
		      <div style="margin-bottom:20px" class="bo-B">
				<div style="margin-bottom:10px"><a class="pointer" href="<?php echo site_url('/quiz/validate_quiz/'.$qz['quid']);?>" > <img src="<?php echo $qz['img'];?> " width="100%"></a><br/>
				</div>
		         <a style="font-size:15px;" class="pointer" href="<?php echo site_url('/quiz/validate_quiz/'.$qz['quid']);?>" ><b><?php echo $qz['quiz_name'];?></a></b>
			 </div>
		  <?php }?>
