...
<main class="container MT70">
	...
	<section class="row">
	    ...
	    <div style="margin-top:-20px;" class="div-leftbar">
			  ...
			  <div>
				  <div class="row1" style="margin-top:20px">
					  <div class="col-xs-10">
						  ...
						  <h4 class="mb-0"><a class="pointer" href="<?php echo site_url('/page/category/'.$mcq['cat_permalink'])?>"><b><?php echo $mcq['category_name']?></b></a> 
				  ...
				  <div class="col-xs-12" style="margin-bottom:10px">
				       <?php if(strpos($mcq['question'],'latex.codecogs.com')!==false || strpos($mcq['question'],'www.w3.org/1998/Math/MathML')!==false){?>
						...
						<?php } else{?>
				       <a href="<?php echo site_url('page/question/'.$mcq['permalink'].'/notsolved'); ?>" style="color:#fff">
					   <?php  if(strpos($mcq['question'], '<iframe')===false && strpos($mcq['question'], '<img')===false){?>
					   <div class="bgqtdiv" >
							<font color="white">
								<div style="background-image:url('https://stemup.app/upload/background/<?php if($mcq['background_template']!=0){ echo $mcq['background_template'];} else{ echo rand(1,20);}?>.jpg'); background-size:100%;background-position:center;" class="outer bgqt">
									<div class="middle">
										<div class="inner" >
											<?php 
	   ...
	   <div class="box-bor MB20">
		  ...
		  <?php foreach($quiz_fun_rb as $qz){?>
		      <div style="margin-bottom:20px" class="bo-B">
				<div style="margin-bottom:10px"><a class="pointer" onclick="popup_require_login()"> <img src="<?php echo $qz['img'];?> " width="100%"></a><br/>
				</div>
		         <a style="font-size:15px;" class="pointer" onclick="popup_require_login()"><b><?php echo $qz['quiz_name'];?></a></b>
			 </div>
		  <?php }?>
