	...
	<section class="row">
  	  <aside class="col-md-2">
		  ...
		  <div class="box-bor MB20 hidden-xs">
			  <div class="text-center mb-10" style="">
			   <?php if($link_photo) { ?>
				  ...
				  <br>
				  <a href="#" class="border-B1"style="font-size: 16px"><?php echo $user_name; ?></a><br> <span class="text-small" align="center">(Học sinh)</span>
			  </div>	  
		  ...
		  <div class="list-group hidden-xs" id="top_menu">
			 ...
			 <h3 class="list-group-item active1">Trắc nghiệm</h3>
			  ...
			  <a href="<?php echo site_url('home_user/quiz_list'); ?>" class="list-group-item" > <i class="fas fa-briefcase" style="margin-right:5px"></i> Kiểm tra</a>
			  <a href="<?php echo site_url('home_user/assign_quiz'); ?>" class="list-group-item"> <i class="fas fa-bullhorn" style="margin-right:5px"></i> Bài được giao 
			  <?php if($num_qas>0){?>
  	  ...
  	  <aside id="main_bussiness" class="col-md-7" style="display:none" >
		  ...
		  <div class="box-lop" id="bannerpage">
			  <div class="line-L">
				  <h1>Học sinh <?php echo $user_name; ?></h1>
					...
					<div class="box-bor MB20">
						<div role="tabpanel">
						  <ul class="nav nav-tabs" role="tablist">
							<li role="presentation" class="active"><a href="#home1" id="text-tabs" data-toggle="tab" role="tab" aria-controls="tab1">Góc thử tài</a></li>
...
"></span></a>
						  ...
						  <div id="tabContent1" class="tab-content">
							<div role="tabpanel" class="tab-pane fade in active" id="home1">
                               ...
                               <p class="MT10 "> Bài trắc nghiệm: <a href="<?php echo site_url('quiz/validate_quiz/'.$qt['quid']);?>"><b><?php echo $qt['quiz_name']?></b></a></p>
							
							   <div class="form-group MT20">
							      
								  <b><?php echo $qt['question'] ?></b>
								</div>
								
	
					
								<form method="post" action="<?php echo site_url('home_user/student_answers/'.$qt['quid'].'/'.$qt['qid'])?>">
								  <div class="row MB20">
									<div class="col-xs-6">
									    
										<label class="radio-inline w-100">
											 
												 <input class="MT10" type="radio" name="optradio" value="0">
											   <div class="input-group">
												 <span class="input-group-addon">A</span>
												 <p style="margin-left:10px;"><?php echo $option_0 ?></p> 
											   </div>
									...
									<div class="col-xs-6">
										<label class="radio-inline w-100">
												 ...
												 <input class="MT10" type="radio" name="optradio" value="1">
											   <div class="input-group">
												 <span class="input-group-addon">B</span>
												<p style="margin-left:10px;"><?php echo $option_1 ?></p>
											   </div>
								...
								<div class="row">
									<div class="col-xs-6">
										<label class="radio-inline w-100">
												 ...
												 <input class="MT10" type="radio" name="optradio" value="2">
											   <div class="input-group">
												 <span class="input-group-addon">C</span>
												   <p style="margin-left:10px;"><?php echo $option_2 ?></p>
											   </div>
									...
									<div class="col-xs-6">
										<label class="radio-inline w-100">
												 ...
												 <input class="MT10" type="radio" name="optradio" value="3">
											   <div class="input-group">
												<span class="input-group-addon">D</span>
												  <p style="margin-left:10px;"><?php echo $option_3 ?></p>
				  ...
				  <div class="row">
					  <div class="col-xs-12" style="margin-bottom:5px">
						  <ul class="list-inline text-bt">
							  ...
							  <?php }?>
							  <li class="col-xs-3"><a class="pointer" data-toggle="collapse" data-target="#comment_area_main_<?php echo $mcq['qid']?>" ><i class="far fa-comment-alt mr-5"></i>Bình luận</span></a></li>
...
"></span>
      ...
      <aside class="col-md-3 rightbar">
      		<!-- <div class="box-bor MB20">
      	    <h3 class="MT0">Lớp: <span class="text-lop">Tiếng Anh</span></h3>
			 <button type="button" class="btn btn-success btn-block">Tham gia một lớp</button>
			  <!--<hr>
