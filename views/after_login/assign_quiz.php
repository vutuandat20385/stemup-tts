...
<html lang="en">
  <head>
	...
	<script src="<?php echo base_url('js/exercise_assigned.js');?>"></script>
					...
					<div class="box-bor MB20">
						<div role="tabpanel" id="tabs">
						  <ul class="nav nav-tabs" role="tablist">
							...
							<li role="presentation"><a href="#home3" data-toggle="tab" role="tab" aria-controls="tab3" id="text-tabs3" style="">Câu đố đã giao</a></li>
						  </ul>
							...
							<div class="data_rs3">
								<table class="table table-bordered">
									  <tr style="background-color: rgb(233, 235, 238);">
											...
											<th>
											<select style="width:60px" onchange="status_answer(this)">
								  ...
								  <P>Đang xem <span id="beginrs3"><?php echo min($limit*$page+1,$num_result);?></span> 
								  đến <span id="endrs3"><?php echo min($limit*($page+1),$num_result);?></span> 
								  trong tổng số <span id="totalrs3"><?php echo $num_result;?></span> kết quả<p>
								  <center>
								  <ul class="pagination listpage pagers3">
									...
									<li class="page-item" onclick="drawpage_rs3(4)"><a class="page-link">5</a></li>
									  ...
									  <li class="page-item"><a class="page-link">...</a></li>
									  <?php } ?>
									  <li class="page-item" onclick="drawpage_rs3(<?php  echo $num_page-1 ?>)"><a class="page-link"><?php echo $num_page ?></a></li>
									<?php }else{?>
									  <li class="page-item active" onclick="drawpage_rs3(0)"><a class="page-link">1</a></li>
									  <?php for($i=1; $i<$num_page; $i++){?>
								  ...
								  <input type="text" id="inf_status" value="0">
								  </div>
							</div>
