...
<div style="min-height:720px">
	...
	if (sizeof($notify)!=0){
        ...
        ?>
		<div class="col-md-12 pointer" style="border-bottom-style: solid;border-bottom-width: 1px"  onMouseOver="this.style.backgroundColor='#85E2E7'" onMouseOut="this.style.backgroundColor='#E9EBEE'"
        ...
        <div id="avatar" class="col-md-1" >
            <img class="img-responsive img-circle" style="padding-top: 4px;height:70px;width:70px" src="<?php echo $dt['photo'] ?>">
        </div>
        <div id="content" class = "col-md-8" >
            ...
            <div id="time">
            <p><?php echo timespan(strtotime($dt['createdate']), time(), 1) ?> ago</p>
            </div>
        </div>
        </div>
        <?php
