		...
		<ul id="tnmncl" class="panel-collapse collapse">
            ...
            <a href="<?php echo site_url('home_user/create_quiz'); ?>" class="list-group-item"> <i class="fas fa-plus-circle" style="margin-right:5px"></i> Tạo bài kiểm tra</a>
			  ...
			  <a href="<?php echo site_url('home_user/results'); ?>" class="list-group-item"> <i class="fas fa-bullseye" style="margin-right:5px"></i> Kết quả</a>
			   <?php if($su==1) {?>
                   <a href="<?php echo site_url('comment_manage'); ?>" class="list-group-item"> <i class="fas fa-video" style="margin-right:5px"></i> Quản lý comment</a>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
								<input type="text" class="form-control form-TK1 col-xs-12" id="group_code" autocomplete="off" name="group_code" style="width:70%" onkeyup="checkcodegroup(event,this.value)" placeholder="Nhập Mã nhóm">
		 ...
		 <div class="box-bor MB20 visible-xs-block">
		  ...
		  <div class="list-group hidden-xs" id="top_menu">
			 ...
			 <a href="#fun_question" class="list-group-item" onclick="fun_question(event);"> <i class="fas fa-question" style="margin-right:5px"></i> Câu hỏi vui</a>
			  ...
			  <a href="<?php echo site_url('home_user/results'); ?>" class="list-group-item"> <i class="fas fa-bullseye" style="margin-right:5px"></i> Kết quả</a>
			  <?php if($su==1) {?>
                  <a href="<?php echo site_url('comment_manage'); ?>" class="list-group-item"> <i class="fas fa-comments"></i> Quản lý comment</a>
					<a href="<?php echo site_url('library/insert_video'); ?>" class="list-group-item"> <i class="fas fa-video" style="margin-right:5px"></i> Thêm video</a>
					<a href="<?php echo site_url('home_user/life_account') ?>" class="list-group-item"> <i class="fa fa-user" style="margin-right:5px"></i> Tài khoản trọn đời</a>
			   <?php } ?>
		  </div>
		  ...
		  <?php if($su==1){?>
			   <div class="box-bor mb-20">
			        <table style="width:100%">
						<tr>
							<td style="padding:5px"><b>Enable app stemup</b></td>
							
						</tr>
						<tr >
							<td style="padding:5px;width:100%"> <input id="es_uid" type="number" placeholder="Nhập mã người dùng" class="form-control"></td> 
							<td style="padding:5px;float:right"><button class="btn  btn-success" onclick="enable_stemup()">Xác nhận</button></td>
						</tr>
					</table>
			   </div>
		  <?php } ?>
		  <div class="box-bor mb-20">
		       <form method="post" action="<?php echo site_url('qbank/new_question_0/4/0')?>">
				  <div class="box-cauhoi">
					  <div class="input-group">
						<?php if($link_photo) { ?>
							<div class="input-group-addon w200"><a href=""><img class="img-responsive img-circle" src="<?php echo $link_photo;?>" alt="" style="width:61px;height: 61px"></a></div>
						<?php } else{ ?>   
		 ...
		 <div class="box-bor1 mb-20 moremcq_<?php echo $mcq['qid']?>">
			  ...
			  <div>
				  <div class="row1" style="margin-top:20px">
					<div class="col-xs-10">
						<div class="w60"><a class="pointer" ><img class="img-responsive img-circle" src="<?php echo base_url('upload/symbol/'.$mcq['cid'].'.png');?>" alt=""></a>
						</div>
						<h4 class="mb-0">
						...
						<span class="text-small1"><i><?php echo $mcq['str_time_ago'] ?></i></span>
					</div>
											...
											<div >
												...
												<table style="width:100%">
												  ...
												  <?php }?>
												   ...
												   <td class="textorg" >
												     <div  class="contentbn">
														<i style="font-weight:200">Cung cấp bởi</i> <b><a><?php echo $mcq['text_license'] ?></b></a>
													 </div>
												   </td>
				  ...
				  <div class="row">
					  <div class="col-xs-12" style="margin-bottom:5px">
						  <ul class="list-inline text-bt">
						      <?php if($mcq['liked']==1){?>
							  <li class="col-xs-2"><a class="btnlike acti pointer"  onclick="like_question(this , <?php echo $mcq['qid'] ?>)"><i class="fas fa-thumbs-up mr-5"></i><span class="hidden-xs">Thích</span></a></li>
							  <?php } else{?>
							  <li class="col-xs-2"><a class="btnlike pointer"  onclick="like_question(this , <?php echo $mcq['qid'] ?>)"><i class="fas fa-thumbs-up mr-5"></i><span class="hidden-xs"> Thích</span></a></li>
							  <?php }?>
...
"></span>
			  ...
			  <?php if($mcq['liked']==1|| $mcq['n_like']>0 ){?>
				  <div class="col-xs-12 bo-B" >		 
					 ...
					 <a class="text_lst" class="f10" href="#">
						 <?php if($mcq['liked']==1){?>
				 ...
				 <div class="row">
					  <div class="col-xs-12" style="margin-bottom:5px">
						  <ul class="list-inline text-bt">
							...
							<li class="col-xs-3">
								<a class="pointer" onclick="changeassign(<?php echo $quiz_fun['quid']; ?>, <?php echo $su;?>)"><i class="fas fa-share-square mr-5"></i><span class="hidden-xs"> Đố </span></a>
							</li>
						  </ul>
					  </div>
						...
						<div id="advance_options" class="collapse">
							...
							<div class="form-group" style="display:none;">
								...
								<select class="js-example-basic-multiple form-control" name="uids[]" multiple="multiple">
			   					<?php if($user_list){foreach($user_list as $k => $uval){ ?>
