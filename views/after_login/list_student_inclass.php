...
js.src = "//connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v3.1";
...
<div class="modal fade" id="changepwdModal" role="dialog">
	...
	<div class="modal fade" id="classaddstdModal" role="dialog">
		<div class="modal-dialog" >	 
			 <div class="modal-content" >
				<div class="modal-header">
				  <button type="button" class="close"  onclick="reload_student(<?php echo $id ?>)" data-dismiss="modal">&times;</button>
				  <?php if($su!=2){ ?>
				...
				<div class="modal-footer">
				 <!--  <button type="button" class="btn btn-success" data-dismiss="modal">Cập nhật</button> -->
				  <button type="button" class="btn btn-default" onclick="reload_student(<?php echo $id ?>)" data-dismiss="modal"> Đóng </button>
				</div>
			 </div>
		 ...
		 <div class="box-bor MB20 visible-xs-block">
		  ...
		  <div class="list-group hidden-xs" id="top_menu">
			 ...
			 <!-- <a href="#" class="list-group-item">Tạo một nhóm nhỏ</a>-->
			  ...
			  <a href="<?php echo site_url('home_user/manage_class'); ?>" class="list-group-item" onclick="manage_class(event);"> <i class="fa fa-box" style="margin-right:5px"></i> <?php if($su==1|| $su==3 || $su==6){ echo 'Quản lý lớp';  } else{ 
			  echo 'Danh sách lớp'; }  ?>
			  </a>
			  <?php if($su==1||$su==3||$su==6){?>
			 <a href="<?php echo site_url('home_user#create_class'); ?>" class="list-group-item"> <i class="fab fa-dropbox" style="margin-right:5px"></i> Tạo một lớp</a>
			  <?php } ?>
			  <?php if($su==2){?>
			  <a data-toggle="modal" data-target="#joinClassModal" class="list-group-item"> <i class="fas fa-handshake" style="margin-right:5px"></i>  Tham gia lớp</a>
			   <?php } ?>
					...
					<div class="box-bor MB20">
						<div role="tabpanel" id="tabs">
						  <ul class="nav nav-tabs" role="tablist">
							<li role="presentation" class="active"><a href="#home1"  id="text-tabs" data-toggle="tab" role="tab" aria-controls="tab1">Thông tin lớp</a></li>
							<li role="presentation"><a href="#home2" data-toggle="tab" role="tab" aria-controls="tab2" id="text-tabs2" >Thảo luận</a></li>
...
<div class="modal fade" id="repair_class" role="dialog">
	<div class="modal-dialog" style="width:40%">
		<form>
		 <div class="modal-content">
			<div class="modal-header">
			...
			<div class="modal-body" id="bodyclass">
					...
					<div class="form-group" id="grade_class">
					   
						
						
					</div>
					<div class="form-group" id="cl_category">
					 
					</div>						
			</div>
			<div class="modal-footer">
			   <span id="repair_cls"><!--<input type="button" value="Chỉnh sửa"  id="" onclick="modal_classes1()" class="btn btn-primary">--></span>
			  <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
			</div>
		 </div>
...
<div class="modal fade" id="invitestdclassModal" role="dialog">
	<div class="modal-dialog" style="width:40%">	 
		...
		<div class="modal fade" id="repair_class1" role="dialog">
			<div class="modal-dialog">	 
				 <div class="modal-content">
					<div class="modal-header">
					  <button type="button" class="close" data-dismiss="modal">&times;</button>
					...
					<div class="modal-body">
						<div id="tenlop">Tên lớp:<input type="text" class="form-control form-TK1 col-xs-12"  name="class_code"></input></div>
						<br><br>						
						<span>
							<select onchange="">
						...
						<span>
							<select onchange="" style="margin-left:20px">
								<option value="0">Môn học</option>								
							</select>
						</span>
						<h3 style="color:blue">Thành viên</h3>
