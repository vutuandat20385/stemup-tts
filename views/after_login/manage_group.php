	...
	<nav class="navbar navbar-stem navbar-fixed-top">
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="defaultNavbar1">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li>
						<a class="text-trang hover text-center text-l" href="<?php echo site_url('library/video'); ?>"><i class="mr-5 fas fa-cloud"></i><br
							 class="hidden-xs">Thư viện</a>
					</li>
					<!--<li>
		...
		<section class="visible-xs-block nav-mobile">
			...
			<ul id="tnmncl" class="panel-collapse collapse">
				...
				<?php } ?>
				<?php if($su==1) {?>
				<a href="<?php echo site_url('library/insert_video'); ?>" class="list-group-item"> <i class="fas fa-video" style="margin-right:5px"></i>
					Thêm video</a>
				<?php } ?>
			</ul>
		...
		<section class="row">
			<aside class="col-md-2">
					...
					<div class="media-object-default">
						<div class="media">
							...
							<div class="media-body">
								<h4 class="media-heading"><a href="#" class="border-B1" ><span id="username"><?php echo $user_name; ?></span><br><span class="text-small1">
								...
								<div class="box-diem-mobile">
									<p class="text-diem1">Sao<span class="text-diem">
											<?php echo $user_point ?></span></p>
								</div>
							</div>
				...
				<div class="list-group hidden-xs">
					...
					<a href="<?php echo site_url('home/about1') ?>" class="list-group-item"><i class="fas fa-bullseye" style="margin-right:5px"></i>
						Giới thiệu</a>
					<a href="<?php echo site_url('home/detail3') ?>" class="list-group-item"><i class="fas fa-object-group" style="margin-right:5px"></i>
						Điều khoản sử dụng</a>
					<a href="<?php echo site_url('home/detail1') ?>" class="list-group-item"><i class="fas fa-folder-open" style="margin-right:5px"></i>
						Hướng dẫn</a>
					<a href="<?php echo site_url('home/detail2') ?>" class="list-group-item"><i class="fa fa-window-restore" style="margin-right:5px"></i>
							...
							<div class="box-bor MB20">
								<div role="tabpanel" id="tabs">
									...
									<ul class="nav nav-tabs" role="tablist">
										...
										<li role="presentation" id="searchh" style="padding-left:55%" class="active">
											<input id="search_mng_qt" style="width:125px; padding-right:30px" onkeyup="drawsearch_mng_gr(this,event)">
											<i class="pointer fas fa-search" onclick="drawsearch_mng_gr_btn()"></i>
										</li>
									...
									<div id="tabContent1" class="tab-content">
										<div role="tabpanel" class="tab-pane fade in active" id="home1">
											<div class="data_mngq">
												<table class="table table-bordered">
													<tr style="background-color: rgb(233, 235, 238);">
														...
														<th>
															Nhóm
															<span>
																<select style="float:right" onchange="drawlimit_mng_gr(this)">
														...
														<th>Mã nhóm</th>
														<th>
															<select style="width:60px" onchange="sort_quiz(this)">
																<option value="all" selected>Tất cả</option>
																<option value="created" <?php if($sortby=='created' ){echo 'selected' ;} ?>>Đã tạo</option>
																<option value="joined" <?php if($sortby=='joined' ){echo 'selected' ;} ?>>Đã tham gia</option>
															</select>
														</th>
														<?php if($su==1){
												?>
													...
													<tr>
														...
														<td>
															<b>
																<a href="#/group/<?php echo $q['sg_id'] ?>" onclick="load_group(<?php echo $q['sg_id'] ?>)">
																	<?php echo $q['sg_name'];?> </a>
															</b>
														</td>
														<td>
															<?php echo $q['sg_code'] ?>
														</td>
														<?php if($uid == $q['created_by']){
												?>
														<td>
															Đã tạo
														</td>
												...
												?>
														<td>
															<?php echo $q['first_name'].' '.$q['last_name']  ?>
														</td>
														<?php
											} ?>
														<?php if($uid == $q['created_by'] || $su==1){
												?>
														<td>
															<a href="<?php echo site_url('social_group/edit_groupp/').'/'.$q['sg_id'] ?>"><i class=" pointer text-warning fas fa-pencil-alt"
																 title="Sửa"></i></a>
															<a onclick="del(<?php echo $q['sg_id'] ?>)"><i class="pointer fas fa-trash-alt" title="Xóa"></i></a>
														</td>
														<?php
											}else{
												?>
														<td><a title="Rời khỏi nhóm" onclick="outgroup(<?php echo $q['sg_id'] ?>,<?php echo $uid ?>)"><i class="fas fa-sign-out-alt"></i></a></td>
														<?php
											} ?>
													</tr>
													<?php } ?>
											...
											<p>Đang xem <span id="beginqt">
													<?php echo min($limit*$page+1,$num_group);?></span>
												đến <span id="endqt">
													<?php echo min($limit*($page+1),$num_group);?></span>
												trong tổng số <span id="totalqt">
													<?php echo $num_group;?></span> nhóm<p>
													<center>
														<ul class="pagination listpage pageqt">
															<?php if($num_page>6){?>
															<li class="page-item active" onclick="drawpage_mng_gr(0)"><a class="page-link">1</a></li>
															<li class="page-item" onclick="drawpage_mng_gr(1)"><a class="page-link">2</a></li>
															<li class="page-item" onclick="drawpage_mng_gr(2)"><a class="page-link">3</a></li>
															<li class="page-item" onclick="drawpage_mng_gr(3)"><a class="page-link">4</a></li>
															<li class="page-item" onclick="drawpage_mng_gr(4)"><a class="page-link">5</a></li>
															<?php if($num_page>7){ ?>
															<li class="page-item"><a class="page-link">...</a></li>
															<?php } ?>
															<li class="page-item" onclick="drawpage_mng_gr(<?php  echo $num_page-1 ?>)"><a class="page-link">
																	<?php echo $num_page ?></a></li>
															<?php }else{?>
															<li class="page-item active" onclick="drawpage_mng_gr(0)"><a class="page-link">1</a></li>
															<?php for($i=1; $i<$num_page; $i++){?>
															<li class="page-item" onclick="drawpage_mng_gr(<?php  echo $i ?>)"><a class="page-link">
																	<?php  echo $i+1 ?></a></li>
															<?php }?>
															<?php }?>
...
<script type="text/javascript">
	function del(id) {
		if (confirm("Delete?"))
			window.location.href = '<?php echo site_url('social_group/delete_group')?>/' + id;
		return true;
	}
	function outgroup(sg_id,uid){
		if(confirm("Bạn có chắc muốn thoát khỏi nhóm này?"))
			window.location.href = '<?php echo site_url('social_group/out_group')?>/' + sg_id +'/'+uid;
		return true;
	}
</script>
