...
//Học sinh
		...
		// $first_name_hs = $user_info['first_name_hs'];
		// $password_hs= $user_info['password_hs'];
		// $email_hs = $user_info['email_hs'];
		// $grade_hs = $user_info['grade_hs'];
		// $this->db->where('email', $email_hs);
		// $n=$this->db->get('savsoft_users')->num_rows();
		// $su_hs=$user_info['su_hs'];
