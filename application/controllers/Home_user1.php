...
function life_account(){
		...
		$data['arr_result'] =  $this->user_model->life_account();
		$this->load->view('after_login/life_account',$data);
		$this->load->view('after_login/modaladdclass');
		$this->load->view('after_login/modaladdgroup');
		$this->load->view('home/footer',$data);
	...
	function add_life_account(){
		...
		/*if($result['status']==0){
			...
			echo "Có lỗi xảy ra, mời bạn kiểm tra lại";
		}*/
		$this->load->view('after_login/add_life_account',$data);
	}
