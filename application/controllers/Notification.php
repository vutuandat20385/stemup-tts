...
class Notification extends CI_Controller {
 ...
 $firebase_serverkey=$this->config->item('firebase_serverkey');
	...
	public function notification_for_user($view=''){
		if($view != ''){
			$this->notify_model->seen_notify_user();
		}
		$data['nuser'] = $this->notify_model->notification_list();
		$data['ncount'] = $this->notify_model->count_unseen();
