...
<script src="<?php echo base_url('editor/jquery.tinymce.min.js');?>"></script>
<script src="<?php echo base_url('editor/tinymce.min.js');?>"></script> -->
<?php $this->load->view('sadmin/head'); ?>
<?php $this->load->view('sadmin/header');?>
<div class="col-md-2 col-left"><?php $this->load->view('sadmin/leftmenu');?></div>
<div class="col-md-10 col-right">
	<?php $lang=$this->config->item('question_lang'); ?>
	...
	<div class="row">
		...
		?>  
		<?php } ?><br><textarea  name="option<?php echo $lno;?>[]" class="form-control"></textarea>
		</div>
	</div>
<?php
}	
