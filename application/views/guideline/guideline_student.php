...
<html lang="en">
  <head>
    ...
    <title>Hướng dẫn cho học sinh </title>
			...
			<div class="box-bor MB20">
				<div role="tabpanel">
				  <ul class="nav nav-tabs" role="tablist">
					<li class="active"><a href="#tabDropDownTwo2" tabindex="-1" data-toggle="tab">Hướng dẫn sử dụng</a>
					  <link rel="stylesheet" type="text/css" href=""> 
					</li>
					<li><a href="#tabDropDownTwo2a" tabindex="-1" data-toggle="tab">Hướng dẫn cho mobile web</a></li>
					
					 <li><a href="#tabDropDownTwo2ab" tabindex="-1" data-toggle="tab">Hướng dẫn cho mobile app</a></li>
				  </ul>
<!---------------------------------------------------------------------------------------------------------------------------------------------------->
