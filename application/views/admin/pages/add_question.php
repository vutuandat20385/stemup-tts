...
<link type="text/css" href="<?php echo base_url('edmin/css/theme.css'); ?>" rel="stylesheet">
    ...
    <div class="row">
            ...
            <div class="col-md-10">
                ...
                <div class="content">
                    ...
                    <form method="post"  id="qf" action="<?php echo site_url('admin/add_question/'.$nop.'/'.$para);?>">
                    <div class="row">
                              ...
                              <div class="panel-body">
                                ...
                                ?>
                                  ...
                                  <div class="form-group col-lg-6" >   
                                    <label   ><?php echo 'Chọn môn học';?></label> 
...
<footer class=" col-xs-12 footer2">
      ...
      <strong>Copyright &copy; 2014-2016 <a href="<?php echo site_url('sadmin/admin_home');?>">Stem admin</a>.</strong> All rights
      reserved.
    </footer>
