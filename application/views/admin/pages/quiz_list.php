...
<style>
	...
	<aside class="col-md-12" style="background: #fff;">
		<?php
						...
						<div role="tabpanel" id="tabs">
							...
							<div id="tabContent1" class="tab-content" >
								<div role="tabpanel" class="tab-pane fade in active" id="home1" >
									<div class="col-md-12 box-filter" style="margin-bottom: 20px; margin-top: 10px; font-size: 16px;">
										<div class="col-md-3">
										...
										<div class="col-md-3">
											<select style="padding:3px ;width:100%; margin-bottom:10px" id="sort-question" onchange="sort_quiz_al(this)">
												...
												<?php if ($su == 1 || $su == 3 || $su == 6) { ?>
													<option value="mine" <?php if ($sortby == 'mine') {
																				echo 'selected';
																			} ?>>
														Bài của tôi
													</option>
												<?php } ?>
												<option value="create_date+desc" <?php if ($sortby == 'create_date desc') {
																						echo 'selected';
																					} ?>>
													Mới nhất
												</option>
												<option value="create_date+asc" <?php if ($sortby == 'create_date asc') {
																					echo 'selected';
																				} ?>>
													Cũ nhất
												</option>
												<option value="answered+desc" <?php if ($sortby == 'answered desc') {
																					echo 'selected';
																				} ?>>
													Nhiều lượt trả lời
												</option>
												<option value="assigned+desc" <?php if ($sortby == 'assigned desc') {
																					echo 'selected';
																				} ?>>
													Nhiều lượt giao bài
												</option>
										...
										<div class="col-md-3 " style="margin-bottom:5px" style="float:left">
											<table style="width:100%;">
												<tr>
													<td><input type="text" style="width:93%" value="<?php echo $search ?>" onchange="filter_quiz_search_al(this)" /></td>
									...
									<div class="box-bor1" style="border:none">
										<?php foreach ($quiz_list as $quiz) { ?>
											<div class="col-md-3 div_quizz div_cteg_<?php echo $quiz['cid'] ?> div_level_<?php echo $quiz['lid'] ?>" style="margin-bottom: 20px;">
												<div class="box-quiz-home" style="height:360px ;background-color:<?php
													...
													<div class="box-title-home">
														<center>
															<a class="pointer" title="<?php echo $quiz['quiz_name'] ?>" href="<?php echo site_url('quiz/validate_quiz/' . $quiz['quid']) ?>">
																<font style="margin:2px" class="quiz_name" size="3px"><?php echo $quiz_name ?></font>
															</a>
														</center>
													</div>
											 ...
											 <a class="btn btn-success" onclick=" changeassign(<?php echo $quiz['quid'] ?>,<?php echo $su ?>)"> Giao bài
														...
														?>
															<a class="btn btn-warning" title="Sửa bài kiểm tra" href="<?php echo site_url("admin/edit_quiz") . '/' . $quiz['quid'] ?>"><i class="fa fa-pencil"></i>
															</a>
