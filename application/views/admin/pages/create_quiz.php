...
?>
<script src="<?php echo base_url() ?>js/admin/create_quiz_stemup.js"></script>
<script>
			...
			<div class="box-body">
				...
				<div class="form-group">
					<span style="float:right; margin-bottom:10px;">
						<input id="search_qbank" style="min-width:250px;margin-top:5%" placeholder="Tìm kiếm câu hỏi" onkeyup="drawsearch_qbank(this,event)" value="">
							...
							?>
								<tr id="<?php echo $qn['qid'] ?>" class="">
									...
									<td><a class="pointer" onclick="mng_preview_qt(<?php echo $qn['qid'] ?>)">
											<svg class="svg-inline--fa fa-eye fa-w-18 pointer text-success" title="Xem trước" aria-labelledby="svg-inline--fa-title-10" data-prefix="fas" data-icon="eye" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" data-fa-i2svg="" style="width: 20px;">
