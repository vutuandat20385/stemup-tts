					...
					<div class="box-bor MB20">
						<div role="tabpanel" id="tabs">
							<ul class="nav nav-tabs" role="tablist">
								<li role="presentation" class="active"><a href="#home1" id="text-tabs" data-toggle="tab" role="tab" aria-controls="tab1">Tên bài kiểm tra</a></li>
								...
								<div role="tabpanel" class="tab-pane fade in active" id="home1">
									<form id="formEditQuiz">
										<div class="form-group">
											...
											<input type="text" id="inpquizname" name="quiz_name" class="form-control" placeholder="<?php echo $this->lang->line('quiz_name'); ?>" value="<?php echo $quiz['quiz_name'] ?>" required>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											?>
												...
												<input type="radio" name="gids[]" value="<?php echo $val['gid']; ?>" <?php if ($key == 1) {
																														echo 'checked';
																													}
																													?>>
										...
										<ul class="nav nav-tabs" id="myTab" role="tablist">
											<li class="active">
												<a class="nav-link" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true" onclick="redraws_qbank_in(0,0,'',10,0)">Sửa câu hỏi</a>
											</li>
											<li class="">
												<a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false" onclick="redraws_qbank_not_in(0,0,'',10,0)">Thêm câu hỏi</a>
											</li>
										</ul>
										<div class="tab-content" id="myTabContent">
											<div class="tab-pane fade active in" id="home" role="tabpanel" aria-labelledby="home-tab">
												<div class="qbank_in">
													<span style="float:right; margin-bottom:10px;">
														<input id="search_qbank_in" style="min-width:250px;margin-top:5%" placeholder="Tìm kiếm câu hỏi" onkeyup="drawsearch_qbank_in(this,event)" value="">
											...
											<div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
												<div class="qbank_not_in">
													<span style="float:right; margin-bottom:10px;">
														<input id="search_qbank_not_in" style="min-width:250px;margin-top:5%" placeholder="Tìm kiếm câu hỏi" onkeyup="drawsearch_qbank_not_in(this,event)" value="">
															...
															?>
																<tr class="">
																	...
																	<td><a class="pointer" onclick="mng_preview_qt(<?php echo $qn['qid'] ?>)">
																			<svg class="svg-inline--fa fa-eye fa-w-18 pointer text-success" title="Xem trước" aria-labelledby="svg-inline--fa-title-10" data-prefix="fas" data-icon="eye" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" data-fa-i2svg="">
