<table class="manage_new table table-bordered" style="">
    ...
    <tr>
        ...
        <td class="ta-c news_delete">
            ...
            <a href="<?php echo base_url("index.php/admin/delete_news").'/'.$n['id'] ?>" class="delete" id="<?php echo $n['id'] ?>"><i class="fa fa-trash" title="Xóa"></i>Xóa</a>
        </td>
    </tr>
    <?php } ?>
