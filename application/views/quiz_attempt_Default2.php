							  ...
							  <div id="q_type<?php echo $qk;?>" class="col-xs-12" style="margin-bottom:10px">
								   ...
								   <div class="bgqtdiv bgqtdiv_e " style="margin-left: 0px;">
										<font color="white" style="font-size: 25px;">
											<div  style="background-image:url('https://do.stem.vn/upload/background/h400/<?php if($question['background_template']!=0){ echo $question['background_template'];} else{ echo rand(1,20);}?>.jpg'); height:330px;" class="outer bgqt_att">
												<div class="middle">
			...
			<div class="tab-content ">
			  <div class="tab-pane active" id="1">
					...
					<div id="fb" style="margin-top:20px">
						<div class="fb-page" 
								data-href="https://www.facebook.com/stem.vn"
								data-width="450px" 
