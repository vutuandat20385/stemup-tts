...
<body>
	...
	<main>
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-9">
						<ol class="breadcrumb">
							...
							<li class="active"><span>Lái ô tô lên Mặt trời hết bao lâu? </span></li>
						</ol>
					</div>
				...
				<div class="container text-muted">
					<div class="blog_title text-center">
						<h1 id="blog_post_name" placeholder="Blog Post Title" data-blog-id="160">Lái ô tô lên Mặt trời hết bao lâu? </h1>
					</div>
				</div>
				<div class="row">
					...
					<div class="col-sm-10">
						<div class="">
							<img class="picture_n" src="<?php echo base_url('images/stemup_images11/pic3a.jpg')?>" >
						</div>
					</div>
					<div class="col-sm-1"></div>
				</div>
		...
		<div class="container text-muted">
			<div class="blog_title text-center">
				<h2 placeholder="Subtitle" style="font-size:160%;">Giả sử bạn sở hữu một chiếc xe hơi có thể đi lên bầu trời và cứ thẳng tiến với tốc độ 100km/h (tốc độ phổ biến cho các đường cao tốc) mà không ngừng nghỉ, không tiếp nhiên liệu, bạn sẽ mất bao lâu để đến Mặt trăng, Mặt trời hay các thiên thể khác trong Thái dương hệ? </h2>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12 mb16 mt16">
							<p class="o_default_snippet_text">Theo Thienvanvietnam, bạn sẽ chỉ tốn gần 1 giờ để ra tới không gian vũ trụ, gần 6 tháng để tới Mặt trăng, 180 năm để đến Mặt trời. Thời gian bạn cần để đến các hành tinh của Mặt trời sẽ lớn hơn rất nhiều, cụ thể là 757năm để đến sao Mộc (khi nó gần Trái đất nhất), 5.000 năm để đến sao Hải vương. </p><p class="o_default_snippet_text">Dựa vào đâu mà các nhà khoa học có thể tính toán được thời gian di chuyển của cái xe hơi kỳ diệu đó? Chính là dựa vào vị trí của Trái đất và các thiên thể khác trong Thái Dương hệ. Trong STEMUP có nhiều câu đố trắc nghiệm rất thú vị về vị trí Trái đất (ảnh), về các hành tinh cũng như vũ trụ bao la. </p><p class="o_default_snippet_text">Để tham gia STEMUP, bạn tải app theo link sau: http://stemup.app. Có 2 loại app: STEMUP dành cho phụ huynh ( màu đỏ) và STEMUP dành cho học sinh (màu cam). Sau khi cài đặt app, bạn chỉ cần đăng nhập tài khoản “đi theo” của con mình là đã có thể giao bài cho con.    </p>
						</div>
					</div>
				</div>
			</section>
