	...
	<main>
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-9">
						<ol class="breadcrumb">
							...
							<li class="active"><span>Dùng STEMUP có lợi gì?  </span></li>
						</ol>
					</div>
				...
				<div class="container text-muted">
					<div class="blog_title text-center">
						<h1 id="blog_post_name" placeholder="Blog Post Title" data-blog-id="160">Dùng STEMUP có lợi gì?</h1>
					</div>
				</div>
				<div class="row">
					...
					<div class="col-sm-10">
						<div class="">
							<img class="picture_n" src="<?php echo base_url('images/stemup_images11/pic2.jpg')?>" >
						</div>
					</div>
					<div class="col-sm-1"></div>
				</div>
		...
		<div class="container text-muted">
			<div class="blog_title text-center">
				...
				<h2 placeholder="Subtitle" style="font-size:160%;">Bạn muốn tìm ra giải pháp hiệu quả nhưng lại tiết kiệm thời gian để đồng hành với con trong việc học? Bạn muốn biết học lực và kiến thức về mọi lĩnh vực của con mình ra sao?  Bạn muốn cập nhật tri thức cho con và cho chính bản thân mình? STEMUP có thể giúp bạn giải quyết tất cả.</h2>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12 mb16 mt16">
							<p class="o_default_snippet_text">Là ứng dụng trí tuệ nhân tạo AI dành cho thiết bị di động do đội ngũ kỹ thuật vô cùng tâm huyết với giáo dục STEM của Công ty Cổ phần Công nghệ DTT phát triển trong nhiều năm qua, STEMUP có tác dụng như một trợ lý ảo đắc lực giúp các bố mẹ bận rộn thỏa mãn mong ước “học cùng con". Phụ huynh không cần bỏ ra mỗi ngày nhiều giờ để kèm trẻ học mà chỉ cần dành 1-2 phút để giao bài tập phù hợp với trình độ con đang học ở trường, kiểm tra và đánh giá sức học của trẻ, chi tiết đến từng môn học.</p><p class="o_default_snippet_text">Khối lượng bài tập và kiến thức trong ứng dụng là con số vài vạn nhưng được sắp xếp khoa học và tiện dụng, phù hợp với mọi trình độ học sinh, với hệ thống clip câu hỏi, bài tập tổng hợp phong phú, đa lĩnh vực và mang tính giáo dục thực tiễn cao.</p><p class="o_default_snippet_text">"Hình thức bài tập trắc nghiệm với việc chấm điểm tự động giúp phụ huynh biết con hiểu đúng, sai về vấn đề gì, từ đó có thể giải thích cho con hoặc củng cố kiến thức cho con. Việc giao bài và trao đổi về kết quả còn giúp tăng kết nối cha mẹ - con cái, điều không dễ dàng với các ông bố bà mẹ bận rộn. </p><p class="o_default_snippet_text">Việc dùng STEMUP cũng là cơ hội để bạn bồi đắp lại những kiến thức cũ đã mai một, nếu bạn muốn. Và như vậy là bạn đang thực sự học cùng con với đầy đủ ý nghĩa của cụm từ này.
							</p><p class="o_default_snippet_text">Về phía trẻ, bạn hãy yên tâm rằng tình trạng con nhăn nhó khi được giao bài tập sẽ không diễn ra, vì trẻ cũng chỉ mất ít phút để hoàn thành trong mấy cú chạm màn hình hay click chuột. Với STEMUP, con bạn đang sử dụng smartphone, máy tính, internet một cách hiệu quả, lành mạnh.
							...
							<h2 placeholder="Subtitle" style="font-size:160%;">Tham gia STEMUP như thế nào? </h2>
							<p class="o_default_snippet_text">Bạn tải app theo link sau: http://stemup.app. Có 2 loại app: STEMUP dành cho phụ huynh ( màu đỏ) và STEMUP dành cho học sinh (màu cam). </p><p class="o_default_snippet_text">Sau khi cài đặt app, bạn chỉ cần đăng nhập tài khoản “đi theo” của con mình là đã có thể giao bài cho con. Trợ lý máy học STEMUP sẽ thông báo kết quả khi con làm bài xong, cho biết con làm sai những câu nào, yếu những mảng nào… mà không cần bạn phải bớt xén thời gian dành cho các công việc khác. Bạn đông con cũng không sao, vì trên cùng một app, bạn có thể giao nhiều bài tập và kiểm tra nhiều con. </p>
						</div>
					</div>
				</div>
			</section>
