...
<body>
	...
	<main>
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-9">
						<ol class="breadcrumb">
							...
							<li class="active"><span>Đổ xăng vào lúc nào có lợi nhất?</span></li>
						</ol>
					</div>
				...
				<div class="container text-muted">
					<div class="blog_title text-center">
						<h1 id="blog_post_name" placeholder="Blog Post Title" data-blog-id="160">Đổ xăng vào lúc nào có lợi nhất? </h1>
					</div>
				</div>
				<div class="row">
					...
					<div class="col-sm-10">
						<div class="">
							<img class="picture_n" src="<?php echo base_url('images/stemup_images11/pic6a.jpg')?>" >
						</div>
					</div>
					<div class="col-sm-1"></div>
				</div>
		...
		<div class="container text-muted">
			<div class="blog_title text-center">
				<h2 placeholder="Subtitle" style="font-size:160%;">Thiệt nhất là đi đi đổ xăng vào thời điểm lúc nóng nhất trong ngày. Khi đó bạn trả tiền cho 10 lít thì thực tế chỉ nhận được 9,1- 9,3 lít thôi, bởi xăng có hệ số giãn nở do nhiệt lớn. </h2>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12 mb16 mt16">
							<p class="o_default_snippet_text">Theo Tintuconline, đổ xăng lúc sáng sớm là có lợi nhất bởi lúc đó mát trời, xăng lại đã trải qua một đêm co lại do nhiệt độ giảm, trở về với thể tích thực của nó.  Ngược lại, lúc nóng nhất trong ngày, bạn  trả tiền 10 lít xăng nhưng có thể chỉ nhận được từ 9,1 – 9,3 lít, phần còn lại là hơi xăng.</p><p class="o_default_snippet_text">Bạn cũng không nên đổ xăng lúc xe bồn đang bơm xăng vào bồn chứa của cây xăng. Lúc xăng bị đổ ào ào vào bồn, áp suất trong bồn gia tăng khiến xăng giãn nở ra. Khi đó, bạn sẽ mua “kèm” một tỷ lệ kha khá khí xăng, hơi xăng. Ngoài ra, bạn không nên đổ xăng quá đầy bình, tránh trình trạng bình xăng bị rò rỉ do xăng giãn nở lúc trời nắng nóng.</p><p class="o_default_snippet_text">Hãy cùng con bạn ôn tiếp câu chuyện giãn nở vì nhiệt bằng các câu trắc nghiệm trên STEMUP nhé. Để tham gia STEMUP, bạn tải app theo link sau: http://stemup.app. Có 2 loại app: STEMUP dành cho phụ huynh ( màu đỏ) và STEMUP dành cho học sinh (màu cam). Sau khi cài đặt app, bạn chỉ cần đăng nhập tài khoản “đi theo” của con mình là đã có thể giao bài cho con.    </p>
						</div>
					</div>
				</div>
			</section>
