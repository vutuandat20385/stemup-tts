					...
					<div id="thumbnail-preview-indicators" class="carousel slide" data-ride="carousel">
						<div class="carousel-inner">
							...
							<div class="item slides">
								<div class="slide-3" style="background-image: url(<?php echo base_url('images/stemup_images/slide-khmt.jpg')?>)">
									<div class="carousel-caption carousel-caption1">
										<h1 class="tle-slide"><a class="text-tintop" href="">STEM Khoa học Máy tính </a></h1>
									</div>
								</div>
							</div>
				...
				<div class="col-md-6">
					<div class="row">
						<div class="col-xs-6 pl-1 pr-1">
							<a class="thum-top1" href="" style="background-image: url(<?php echo base_url('images/stemup_images/stem-khmt.jpg')?>)">
								<span class="text-top1">STEM Khoa học Máy tính</span>
							</a>
						</div>
						<div class="col-xs-6 pl-1 pr-1">
							<a class="thum-top1" href="" style="background-image: url(<?php echo base_url('images/stemup_images/stem-robothon.jpg')?>)">
								<span class="text-top1">STEM-ROBOTICS cơ bản, nâng cao (Pre-ROBOTHON)</span>
							</a>
						</div>
					</div>
					<div class="row">
						<div class="col-xs-6 pl-1 pr-1">
							<a class="thum-top1" href="" style="background-image: url(<?php echo base_url('images/stemup_images/stem-iot.jpg')?>)">
								<span class="text-top1">STEM IoT</span>
							</a>
						</div>
						<div class="col-xs-6 pl-1 pr-1">
							<a class="thum-top1" href="" style="background-image: url(<?php echo base_url('images/stemup_images/stem-khdl.png')?>)">
								<span class="text-top1">STEM Khoa học dữ liệu</span>
							</a>
						</div>
					</div>
				</div>
