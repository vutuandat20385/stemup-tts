        ...
        <center class="quiz-list-right-col">
            <?php for ($i = 0; $i < $count_page_qt; $i++) { ?>
                <div style="margin-top:10px">
                    <?php if ($i == 0) {
                    ?> <ol class="carousel-indicators carousel-Quizz hidden-dt" style="margin-top:0px;margin-left:-98%;width: 100%"> <?php                                                                                                                              } else {                                                                                                          ?> <ol class="carousel-indicators carousel-Quizz hidden-dt" style="margin-top:0px;margin-left:-98%;width: 100%"> <?php                                                                                                                                                                                                                      } ?>
                            <?php foreach ($questions as $qk => $question) {
                                if ($qk >= $i * 7 && $qk < ($i + 1) * 7) { ?>
