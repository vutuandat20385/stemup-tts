...
<nav class="container">
  <div class="row padTB10">
	...
	<img class="img-responsive col-md-10 col-md-offset-1" src="<?php echo base_url('images/home_anh15.jpg');?>" alt="">
	 <h1 style="text-align:center" class="col-md-10 col-md-offset-1"> <b>Nhà trường, xã hội</b></h1>
	 <h4 style="text-align:center" class="col-md-8 col-md-offset-2">
	Trong mục tiêu đưa công nghệ vào công tác giảng dạy, nhiều trường đối mặt với tình trạng giáo viên không mặn mà với những phần mềm, ứng dụng hay nền tảng mà ban giám hiệu yêu cầu sử dụng, bởi họ cảm thấy bị thêm việc, trong khi các hoạt động thường quy đã chiếm nhiều thời gian. Việc số hóa dạy và học vì thế chỉ mang tính hình thức. stemup.app góp phần tối ưu và minh bạch hóa một trong các khâu quan trọng và chiếm thời lượng khá lớn của giáo viên: Ra bài tập, bài kiểm tra, bài thi, chấm điểm và đánh giá kết quả.  </h3>
	<h4 style="text-align:center"class="col-md-8 col-md-offset-2">
