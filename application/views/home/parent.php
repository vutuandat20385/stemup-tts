...
<img class="img-responsive col-md-10 col-md-offset-1" src="<?php echo base_url('images/home_anh51.jpg');?>" alt="">	
 <h1 style="text-align:center" class="col-md-10 col-md-offset-1"> <b>Phụ huynh</b></h1>
 <h4 style="text-align:center" class="col-md-8 col-md-offset-2"> 
 Với các ông bố bà mẹ bận rộn, học cùng con là một mong ước khó thỏa mãn bởi bạn không thể dành ra mỗi ngày hàng tiếng đồng hồ để kèm trẻ học, hay kiểm tra xem con học gì, có thực sự hiểu bài hay không. Đó là chưa kể nhiều phụ huynh đã quên phần lớn các kiến thức mà họ học từ vài chục năm trước. Nhưng nếu con bạn là thành viên của stemup.app, cho dù không có thời gian, cho dù kiến thức đã rơi rụng, bạn vẫn có thể học cùng con, kiểm tra và đánh giá sức học của trẻ, chi tiết đến từng bài học. </h4>
<h4 style="text-align:center"class="col-md-8 col-md-offset-2">
	 Hình thức bài tập trắc nghiệm với việc chấm điểm tự động cho phép bạn làm điều đó. Chỉ cần đăng nhập tài khoản “đi theo” con mình, bạn đã có đủ kết quả từng bài tập, bài thi, biết con làm sai những câu nào, yếu những mảng nào. Không chỉ theo dõi kết quả những bài do giáo viên giao, chính bạn cũng có thể giới thiệu cho con các bài tập trên hệ thống và kiểm tra kết quả mà không cần phải bớt xén thời gian dành cho các công việc khác. Đây cũng là cơ hội để bạn bồi đắp lại những kiến thức cũ đã mai một, nếu bạn muốn, và như vậy là bạn đang thực sự học cùng con với đầy đủ ý nghĩa của cụm từ này. 
</h4>
<h4 style="text-align:center"class="col-md-8 col-md-offset-2">
Còn nếu bạn chưa phải là bố mẹ của học sinh nào trên hệ thống? Việc tự mình làm các bài tập trắc nghiệm kiến thức cũng là một cách giải trí và thể dục trí não không tồi. Hãy thử xem mình có thông minh và hiểu biết “bằng học sinh lớp 5” không nhé!
</h4>	 
