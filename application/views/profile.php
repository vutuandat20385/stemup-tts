...
<div class="container">
	<div class="row">
    	...
    	<div class="col-sm-2"><a href="/users" class="pull-right"><img title="profile image" class="img-circle img-responsive" src="https://www.gravatar.com/avatar/<?php echo md5($result['email']);?>?s=100"></a></div>
    </div>
    <div class="row">
