<div class="container">
	...
	<div class="row">
     	<form method="post" action="<?php echo site_url('data/add_new_dataitem');?>">
			<div class="col-md-8">
				<br> 
 				<div class="login-panel panel panel-default">
					<div class="panel-body">
						...
						<div class="form-group">	 
							...
							?>
								<option value="<?php echo $val['gid'];?>"><?php echo $val['datagroup_name'];?></option>
							<?php 
								}
							?>
							</select>
						...
						<div class="form-group">	 
							...
							<input type="text" required  name="dataitem_name"  class="form-control"/> 
						</div>

						<div class="form-group">	 
							<label for="inputEmail"><?php echo $this->lang->line('dataitem_code');?></label> 
							<input type="text" required  name="dataitem_code"  class="form-control"/> 
						</div>

						<div class="form-group">	 
							<label for="inputEmail"><?php echo $this->lang->line('dataitem_level');?></label> 
							<input type="text" required  name="dataitem_level" id="dataitem_level" class="form-control" value="1" onchange="changeDataGroup();" /> 
						</div>
