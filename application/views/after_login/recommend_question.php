...
<html lang="en">
  <head>
    ...
    <title>Câu hỏi cho bạn</title>
		<meta name="Description" content="<?php echo $category?>" />
		...
		<div class="modal fade" id="createchildModal" role="dialog">
			<div class="modal-dialog">	 
				 <div class="modal-content">
					...
					<div class="modal-body">
					   <form method="post" action="<?php echo site_url('/home_user/create_child');?>">
		 ...
		 <div style="margin-top:20px">			   
		  ...
		  <div class="list-group hidden-xs" id="top_menu">
			 ...
			 <h3 class="list-group-item active1">Trắc nghiệm</h3>
			  <a href="<?php echo site_url('home_user');?>" class="list-group-item createQuestionItem"><i class="fa fa-question" style="margin-right:5px"></i> Câu hỏi vui</a>
