							     ...
							     <div class="data_mngq">
							      <table class="table table-bordered">
									  <tr style="background-color: rgb(233, 235, 238);">
											...
											<th >
											<select style="width:60px" onchange="drawlv_mng_qt(this)">
											...
											<th colspan="3">
											<input id="search_mng_qt" style="width:60px" onkeyup="drawsearch_mng_qt(this,event)"> 
											<i class="pointer fas fa-search" onclick="drawsearch_mng_qt_btn()"></i>
											</th>
									   ...
									   <tr>
											...
											<td>
											<a><i class="pointer fas fa-trash-alt" onclick="remove_entry_e('qbank/remove_question/<?php echo $q['qid']?>', 'câu hỏi');" title="Xóa"></i></a>
											</td>
