...
<html lang="en">
  <head>
    ...
    <script src="<?php echo base_url('js/event_racing.js');?>"></script>	
	<script>
  	  ...
  	  <aside class="col-md-7">
			  ...
			  <div role="tabpanel">
			    <ul class="nav nav-tabs" role="tablist">
			      <li role="presentation" class="active"><a class="f21" href="#home1" data-toggle="tab" role="tab" aria-controls="tab1">Bảng xếp hạng (
				 <span id="day_ev"> <?php echo $today;?></span>)</a></li>
			      <li role="presentation"><a href="#paneTwo1" data-toggle="tab" role="tab" aria-controls="tab2">Bảng xếp hạng Tuần <?php echo $no_week_of_month ?> tháng <?php echo $month ?></a></li>
					<li role="presentation"><a href="#paneTwo2" data-toggle="tab" role="tab" aria-controls="tab2">Bảng xếp hạng tổng</a></li>
					...
					<table class="table table-hover table-striped" id="tbl_ev_byday">
						<thead>
						  <tr class="bg-eee">
							...
							<th class="text-right">Điểm Vui</th>
							<th class="text-right">Điểm Học</th>
							<th class="text-right">Tổng điểm</th>
						  </tr>
						</thead>
						<tbody>
						  <?php foreach($today_points as $i=>$dp){?>
						  <tr>
							<td class="text-center <?php if($i<3){ ?> bg-primary <?php } ?>"><?php echo ($i+1)?></td>
							<td><a href=""><?php echo $dp['first_name']." ".$dp['last_name'] ?></a></td>
							<td class="text-right"><?php echo $dp['do_points']; ?></td>
							  <td class="text-right"><?php echo $dp['vui_points'];?></td>
							  <td class="text-right"><?php echo $dp['hoc_points'];?></td>
							  <td class="text-right"><strong><?php echo $dp['total_points'];?></strong></td>
						  </tr>
						  <?php } ?>
					  ...
					  <div class="row">
						  <div class="col-xs-7 see_all_link_day"><p class="text-right"><a class="pointer" onclick="redraw_all_ev_tbl_day('<?php echo $today;?>',0)">Xem tất cả</a></p></div>
						  <div class="col-xs-5" title="Xem theo ngày">
						     <a class="pull-right ">
			      ...
			      <div role="tabpanel" class="tab-pane fade" id="paneTwo1">
					<table class="table table-hover table-striped" id="tbl_ev_byweek">
						...
						<?php foreach($week_points as $i=>$wp){?>
						  <tr>
							<td class="text-center <?php if($i<3){ ?> bg-primary <?php } ?>"><?php echo ($i+1)?></td>
							<td><a href=""><?php echo $wp['first_name']." ".$wp['last_name'] ?></a></td>
							<td class="text-right"><?php echo $wp['dps']; ?></td>
							  <td class="text-right"><?php echo $wp['vps'];?></td>
							  <td class="text-right"><?php echo $wp['hps'];?></td>
							  <td class="text-right"><strong><?php echo $wp['tps'];?></strong></td>
						  </tr>
						  <?php } ?>
						</tbody>
					</table>
					  <div class="row">
						 <div class="col-xs-7 see_all_link_week"><p class="text-right"><a class="pointer" onclick="redraw_all_ev_tbl_week('<?php echo $monday;?>','<?php echo $sunday;?>',0)">Xem tất cả</a></p></div>
						  <div class="col-xs-5" title="Xem theo ngày">
						     <a class="pull-right ">
								<i class="far fa-calendar-alt mr-5"></i>
								<input id="datepicker_event_1" type="button" style="margin-right:5px" value="Xem theo ngày"> 
							  </a>
						  </div>
					  </div>
		          </div>
			      <div role="tabpanel" class="tab-pane fade" id="paneTwo2">
					<table class="table table-hover table-striped" id="tbl_ev_byalltime">
						...
						<tbody>
						  ...
						  <tr>
							<td class="text-center <?php if($i<3){ ?> bg-primary <?php } ?>"><?php echo ($i+1)?></td>
							<td><a href=""><?php echo $atp['first_name']." ".$atp['last_name'] ?></a></td>
							<td class="text-right"><?php echo $atp['dps']; ?></td>
							  <td class="text-right"><?php echo $atp['vps'];?></td>
							  <td class="text-right"><?php echo $atp['hps'];?></td>
							  <td class="text-right"><strong><?php echo $atp['tps'];?></strong></td>
						  </tr>
						  <?php } ?>
						</tbody>
					</table>
					  <div class="row">
						  <div class="col-xs-7 see_all_link_alltime"><p class="text-right"><a class="pointer" onclick="redraw_all_ev_tbl_alltime(0)">Xem tất cả</a></p></div>
						 <div class="col-xs-5" title="Xem theo ngày">
						     <a class="pull-right ">
								<i class="far fa-calendar-alt mr-5"></i>
								<input id="datepicker_event_2" type="button" style="margin-right:5px" value="Xem theo ngày"> 
							  </a>
						  </div>
					  </div>
