			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
								<input type="text" class="form-control form-TK1 col-xs-12" id="group_code" autocomplete="off" name="group_code" style="width:450px" onkeyup="checkcodegroup(event,this.value)" placeholder="Nhập Mã nhóm">
								<button class="btn btn-primary" id="btjoingroup" onclick="checkcodegroupbt()" style="margin-left:30px" >Xác nhận</button>
		   ...
		   <div class="box-bor MB20 hidden-xs" style="text-align: center;">
			  <div class="text-center mb-10"  style="margin-bottom: -8px">
			   <?php if($link_photo) { ?>
				  ...
				  <br>
				  <a href="#" class="border-B1"><?php echo $user_name; ?></a> <span class="text-small">(<?php if($su==3){?>Giáo viên<?php }?><?php if($su==1){?>Admin<?php }?><?php if($su==8){?>Tổ chức<?php }?>  <?php if($su==6){?> Quản trị  <?php }?>)</span>
			   </div>	  
