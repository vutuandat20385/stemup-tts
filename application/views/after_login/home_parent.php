	...
	<section class="row">
		...
		?>	
		  <div class="box-lop" id="bannerpage">
			  <div class="line-L">
				  <h1>Phụ huynh <?php echo $user_name?></h1>
			...
			<div class="box-bor MB20">
				<div role="tabpanel">
					...
					<div id="tabContent1" class="tab-content">
						<div role="tabpanel" class="tab-pane fade in active" id="home1" data-quiz="parent"></div>
					</div>
				</div>
			</div>
				  ...
				  <div class="row1" style="margin-top:20px">
					  <div class=col-xs-10>
						  ...
						  <h4 class="mb-0"><a class="pointer" href="<?php echo site_url('/page/category/'.$mcq['category_permalink'])?>"><b><?php echo $mcq['category_name']?></b></a> 
						   <span style="margin-left:10px" class="dropdown pointer"><a  class="dropdown-toggle" id="dropdownMenuLink" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" >
							<span class="caret caret_e"></span></a>
						  <div class="dropdown-menu dropdown-menu_e" style="overflow-y:scroll;height: 273px;font-size:15px" aria-labelledby="dropdownMenuLink">
						...
						<?php if(strpos($mcq['question'], '<iframe')===false){ ?>
						 <div class="mcq_multimd assqid-<?php echo $mcq['qid']?>">
							<center style="margin-bottom:20px">
							 <?php if($mcq['create_su']==8 && $mcq['text_license'] && $mcq['show_logo']==1) {?>
								<div class="imgwlogo">
