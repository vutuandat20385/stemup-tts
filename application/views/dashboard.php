...
<?php 
echo "Page rendered in <strong>{elapsed_time}</strong> seconds. You may improve it by hosting on recommended hosting. <a href='https://savsoftquiz.com/affiliate.php' target='af'>Click here</a> ";
?>
</div>
