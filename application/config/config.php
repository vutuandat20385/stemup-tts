...
$config['sq_license_key'] = $sq_license_key;

$config['smsgateway']="http://msg.msgclub.net/rest/services/sendSMS/sendGroupSms?AUTH_KEY=APIKEYHERE&message={message}&senderId=DOBOZZ&routeId=1&mobileNos={mobile_number}&smsContentType=english";
...
// default group id
$config['default_gid']=5;

  
// Allow open quiz( true or false )
$config['open_quiz']=true;

// Enable question2answer.org ( true or false )
$config['q2a']=true;
// path to question2answer (ends with slash)
$config['q2a_path']="http://localhost/question2answer/";

// enable sharethis (true or false)
$config['sharethis']=true;
// property key
$config['sharethis_property']="59a1a68693086300127f937b8888";

  
 
// display advertisement after X number of seconds of starting quiz
$config['showadvertisement_after']=60;
// display advertisement during quiz for seconds
$config['showadvertisement_sec']=10;
...
$config['smtp_hostname'] = $ms_hostname;
// smtp username
$config['smtp_username'] = $ms_username;
// smtp password
$config['smtp_password'] = $ms_password;
// smtp outgoing port. eg for gmail its 465, outlook 587, yahoo 465 for other contact your mailing administrator
$config['smtp_port'] = $ms_port;
...
// email send from
$config['fromemail']="noreply5@stem.vn";
// from name
$config['fromname']="stemup.app";
...
$config['firebase_serverkey']= $firebase_serverkey;
$config['firebase_topic']= $firebase_topic;


$config['quiz_templates']=array('Default','Default_PROCTOR -Plugin_Not_Installed','Advance','Practice','IN');
...
// if SQLc plugin installed (live classroom with video streaming )
$config['SQLc']=false;
$config['SQLc_user_id']="1";
$config['SQLc_key']="123";
$config['SQLc_path']="http://localhost/SQLc/";
