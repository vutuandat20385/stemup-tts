...
$(document).ready(function(){
   if(window.location.hash) {
	  ...
	  if(hash=='create_question'){
		  //createQuestionItem(this);
	  }
    /* else if(hash=='manage_question'){
		  if(su!=6)
		       manageQuestionItem(this);
		   else
			   manageQuestion_mod(this);
	  }*/
	  /*else if(hash=='create_quiz'){
		  create_quiz(this);
	  }*/
	  /*else if(hash=='manage_quiz'){
		  if(su!=6)
			checkItem(this);
		  else
		    checkItem_mod(this);
	  }
	  else if(hash=='assign_quiz'){
		  quizAssignTo(this);
	  }
	  else if(hash=='result'){
		  resultItem(this);
	  }
	  else if(hash=='manage_class'){
		  manage_class(this);
	  }*/
	  else if(hash=='create_class'){
		  create_class(this);
		 
	  }
	  else if(hash=='manage_group'){
		  manageGroup(this);
	  }
	  else if(hash=='create_group'){
		  createGroup(this);
	  }else if(hash=='gocthutai'){
	  		gocthutai(this);
	  }
	  else if(hash=='accounttype'){
	  		choosetypeaccount(this);
	  }
	  else if(hash=='fun_question'){
	  		fun_question(this);
	  }
     
  } else {
      if($('#home1').data('quiz') == 'parent'){
	  	//checkItem(this);
	  }
  }
...
function load_tab1(){
	...
	$("#home2").attr("class","tab-pane fade");
   ...
   $("#home1").empty();
		...
		if($(window).width()<1100){
			for(i=0; i<10; i++){
					htmlx+=	'<td class="tranbtsbg openbgc"  style="opacity: 1; transform: translateX('+30*i+'px);">'+
						'<a id="bgq'+(i+1)+'">'+
							'<img src="https://do.stem.vn/upload/background/'+(i+1)+'.jpg" class="imgbgrbt" >'+
						'</a>'+
					   '</td>';
			}	
		   for(i=10; i<20; i++){
	...
	$("#bgq1").on('click',function(){                                                  
		...
		if(x.indexOf('<img')==-1 && x.indexOf("<iframe")==-1){
			$("#question_wbg>.modal-dialog>.modal-content>.modal-body").attr('style','text-shadow: -2px 0 black, 0 2px black, 2px 0 black, 0 -1px black;background-image:url("https://do.stem.vn/upload/background/1.jpg"); height:300px');
	...
	$("#mbgq1").on('click',function(){
   	...
   	$("#bgq2").on('click',function(){                                                  
		...
		x= tinyMCE.get('question').getContent();
		if(x.indexOf('<img')==-1 && x.indexOf("<iframe")==-1){
			$("#question_wbg>.modal-dialog>.modal-content>.modal-body").attr('style','text-shadow: -2px 0 black, 0 2px black, 2px 0 black, 0 -1px black;background-image:url("https://do.stem.vn/upload/background/2.jpg"); height:300px');
			$("#fclqpr").attr('color','white');
			$("#bgqid").val(2);
			x=x.replace(/<\/?[^>]+(>|$)/g, "");
		}
	...
	$("#mbgq2").on('click',function(){
  	...
  	$("#bgq3").on('click',function(){                                                  
		...
		x= tinyMCE.get('question').getContent();
		if(x.indexOf('<img')==-1 && x.indexOf("<iframe")==-1){
			$("#question_wbg>.modal-dialog>.modal-content>.modal-body").attr('style','text-shadow: -2px 0 black, 0 2px black, 2px 0 black, 0 -1px black;background-image:url("https://do.stem.vn/upload/background/3.jpg"); height:300px');
			$("#fclqpr").attr('color','white');
			$("#bgqid").val(3);
			x=x.replace(/<\/?[^>]+(>|$)/g, "");
		}
	...
	$("#bgq4").on('click',function(){                                                  
		...
		x= tinyMCE.get('question').getContent();
		if(x.indexOf('<img')==-1 && x.indexOf("<iframe")==-1){
			$("#question_wbg>.modal-dialog>.modal-content>.modal-body").attr('style','text-shadow: -2px 0 black, 0 2px black, 2px 0 black, 0 -1px black;background-image:url("https://do.stem.vn/upload/background/4.jpg"); height:300px');
			$("#fclqpr").attr('color','white');
			x=x.replace(/<\/?[^>]+(>|$)/g, "");
			$("#bgqid").val(4);
		}
	...
	$("#bgq5").on('click',function(){                                                  
		...
		x= tinyMCE.get('question').getContent();
		if(x.indexOf('<img')==-1 && x.indexOf("<iframe")==-1){
			$("#question_wbg>.modal-dialog>.modal-content>.modal-body").attr('style','text-shadow: -2px 0 black, 0 2px black, 2px 0 black, 0 -1px black;background-image:url("https://do.stem.vn/upload/background/5.jpg"); height:300px');
			$("#fclqpr").attr('color','white');
			x=x.replace(/<\/?[^>]+(>|$)/g, "");
			$("#bgqid").val(5);
		}
	...
	$("#bgq6").on('click',function(){                                                  
		...
		x= tinyMCE.get('question').getContent();
		if(x.indexOf('<img')==-1 && x.indexOf("<iframe")==-1){
			$("#question_wbg>.modal-dialog>.modal-content>.modal-body").attr('style','text-shadow: -2px 0 black, 0 2px black, 2px 0 black, 0 -1px black;background-image:url("https://do.stem.vn/upload/background/6.jpg"); height:300px');
			$("#fclqpr").attr('color','white');
			x=x.replace(/<\/?[^>]+(>|$)/g, "");
			$("#bgqid").val(6);
		}
	...
	$("#bgq7").on('click',function(){                                                  
		...
		x= tinyMCE.get('question').getContent();
		if(x.indexOf('<img')==-1 && x.indexOf("<iframe")==-1){
			$("#question_wbg>.modal-dialog>.modal-content>.modal-body").attr('style','text-shadow: -2px 0 black, 0 2px black, 2px 0 black, 0 -1px black;background-image:url("https://do.stem.vn/upload/background/7.jpg"); height:300px');
			$("#fclqpr").attr('color','white');
			x=x.replace(/<\/?[^>]+(>|$)/g, "");
			$("#bgqid").val(7);
		}
	...
	$("#bgq8").on('click',function(){                                                  
		...
		x= tinyMCE.get('question').getContent();
		if(x.indexOf('<img')==-1 && x.indexOf("<iframe")==-1){
			$("#question_wbg>.modal-dialog>.modal-content>.modal-body").attr('style','text-shadow: -2px 0 black, 0 2px black, 2px 0 black, 0 -1px black;background-image:url("https://do.stem.vn/upload/background/8.jpg"); height:300px');
			$("#fclqpr").attr('color','white');
			x=x.replace(/<\/?[^>]+(>|$)/g, "");
			$("#bgqid").val(8);
		}
	...
	$("#bgq9").on('click',function(){                                                  
		...
		x= tinyMCE.get('question').getContent();
		if(x.indexOf('<img')==-1 && x.indexOf("<iframe")==-1){
			$("#question_wbg>.modal-dialog>.modal-content>.modal-body").attr('style','text-shadow: -2px 0 black, 0 2px black, 2px 0 black, 0 -1px black;background-image:url("https://do.stem.vn/upload/background/9.jpg"); height:300px');
			$("#fclqpr").attr('color','white');
			x=x.replace(/<\/?[^>]+(>|$)/g, "");
			$("#bgqid").val(9);
		}
	...
	$("#bgq10").on('click',function(){                                                  
		...
		x= tinyMCE.get('question').getContent();
		if(x.indexOf('<img')==-1 && x.indexOf("<iframe")==-1){
			$("#question_wbg>.modal-dialog>.modal-content>.modal-body").attr('style','text-shadow: -2px 0 black, 0 2px black, 2px 0 black, 0 -1px black;background-image:url("https://do.stem.vn/upload/background/10.jpg"); height:300px');
			$("#fclqpr").attr('color','white');
			x=x.replace(/<\/?[^>]+(>|$)/g, "");
			$("#bgqid").val(10);
		}
	...
	$("#bgq11").on('click',function(){                                                  
		...
		if(x.indexOf('<img')==-1 && x.indexOf("<iframe")==-1){
			$("#question_wbg>.modal-dialog>.modal-content>.modal-body").attr('style','text-shadow: -2px 0 black, 0 2px black, 2px 0 black, 0 -1px black;background-image:url("https://do.stem.vn/upload/background/11.jpg"); height:300px');
			$("#fclqpr").attr('color','white');
			$("#bgqid").val(11);
			x=x.replace(/<\/?[^>]+(>|$)/g, "");
		}
	...
	$("#bgq12").on('click',function(){                                                  
		...
		if(x.indexOf('<img')==-1 && x.indexOf("<iframe")==-1){
			$("#question_wbg>.modal-dialog>.modal-content>.modal-body").attr('style','text-shadow: -2px 0 black, 0 2px black, 2px 0 black, 0 -1px black;background-image:url("https://do.stem.vn/upload/background/12.jpg"); height:300px');
			$("#fclqpr").attr('color','white');
			$("#bgqid").val(12);
			x=x.replace(/<\/?[^>]+(>|$)/g, "");
		}
	...
	$("#bgq13").on('click',function(){                                                  
		...
		if(x.indexOf('<img')==-1 && x.indexOf("<iframe")==-1){
			$("#question_wbg>.modal-dialog>.modal-content>.modal-body").attr('style','text-shadow: -2px 0 black, 0 2px black, 2px 0 black, 0 -1px black;background-image:url("https://do.stem.vn/upload/background/13.jpg"); height:300px');
			$("#fclqpr").attr('color','white');
			$("#bgqid").val(13);
			x=x.replace(/<\/?[^>]+(>|$)/g, "");
		}
	...
	$("#bgq14").on('click',function(){                                                  
		...
		if(x.indexOf('<img')==-1 && x.indexOf("<iframe")==-1){
			$("#question_wbg>.modal-dialog>.modal-content>.modal-body").attr('style','text-shadow: -2px 0 black, 0 2px black, 2px 0 black, 0 -1px black;background-image:url("https://do.stem.vn/upload/background/14.jpg"); height:300px');
			$("#fclqpr").attr('color','white');
			$("#bgqid").val(14);
			x=x.replace(/<\/?[^>]+(>|$)/g, "");
		}
	...
	$("#bgq15").on('click',function(){                                                  
		...
		if(x.indexOf('<img')==-1 && x.indexOf("<iframe")==-1){
			$("#question_wbg>.modal-dialog>.modal-content>.modal-body").attr('style','text-shadow: -2px 0 black, 0 2px black, 2px 0 black, 0 -1px black;background-image:url("https://do.stem.vn/upload/background/15.jpg"); height:300px');
			$("#fclqpr").attr('color','white');
			$("#bgqid").val(15);
			x=x.replace(/<\/?[^>]+(>|$)/g, "");
		}
	...
	$("#bgq16").on('click',function(){                                                  
		...
		if(x.indexOf('<img')==-1 && x.indexOf("<iframe")==-1){
			$("#question_wbg>.modal-dialog>.modal-content>.modal-body").attr('style','text-shadow: -2px 0 black, 0 2px black, 2px 0 black, 0 -1px black;background-image:url("https://do.stem.vn/upload/background/16.jpg"); height:300px');
			$("#fclqpr").attr('color','white');
			$("#bgqid").val(16);
			x=x.replace(/<\/?[^>]+(>|$)/g, "");
		}
	...
	$("#bgq17").on('click',function(){                                                  
		...
		if(x.indexOf('<img')==-1 && x.indexOf("<iframe")==-1){
			$("#question_wbg>.modal-dialog>.modal-content>.modal-body").attr('style','text-shadow: -2px 0 black, 0 2px black, 2px 0 black, 0 -1px black;background-image:url("https://do.stem.vn/upload/background/17.jpg"); height:300px');
			$("#fclqpr").attr('color','white');
			$("#bgqid").val(17);
			x=x.replace(/<\/?[^>]+(>|$)/g, "");
		}
	...
	$("#bgq18").on('click',function(){                                                  
		...
		if(x.indexOf('<img')==-1 && x.indexOf("<iframe")==-1){
			$("#question_wbg>.modal-dialog>.modal-content>.modal-body").attr('style','text-shadow: -2px 0 black, 0 2px black, 2px 0 black, 0 -1px black;background-image:url("https://do.stem.vn/upload/background/18.jpg"); height:300px');
			$("#fclqpr").attr('color','white');
			$("#bgqid").val(18);
			x=x.replace(/<\/?[^>]+(>|$)/g, "");
		}
	...
	$("#bgq19").on('click',function(){                                                  
		...
		if(x.indexOf('<img')==-1 && x.indexOf("<iframe")==-1){
			$("#question_wbg>.modal-dialog>.modal-content>.modal-body").attr('style','text-shadow: -2px 0 black, 0 2px black, 2px 0 black, 0 -1px black;background-image:url("https://do.stem.vn/upload/background/19.jpg"); height:300px');
			$("#fclqpr").attr('color','white');
			$("#bgqid").val(19);
			x=x.replace(/<\/?[^>]+(>|$)/g, "");
		}
	...
	$("#bgq20").on('click',function(){                                                  
		...
		if(x.indexOf('<img')==-1 && x.indexOf("<iframe")==-1){
			$("#question_wbg>.modal-dialog>.modal-content>.modal-body").attr('style','text-shadow: -2px 0 black, 0 2px black, 2px 0 black, 0 -1px black;background-image:url("https://do.stem.vn/upload/background/20.jpg"); height:300px');
			$("#fclqpr").attr('color','white');
			$("#bgqid").val(20);
			x=x.replace(/<\/?[^>]+(>|$)/g, "");
		}
						...
						success: function(results){
							...
							if(dataq.background_template!=0){
								q='<div  id="qwbgpr" style="font-size: 33px; text-align:center ;font-weight: 700;" >'
								   +'<font color="white"><div style="padding: 120px 27px;text-shadow: -2px 0 black, 0 2px black, 2px 0 black, 0 -1px black;background-image:url(\'https://do.stem.vn/upload/background/'+dataq.background_template+'.jpg\'); height:300px">'+q+
		                         '</div></font></div>';
							}
							$("#questionp").empty();
...
function quizAssignTo_1(page,uidz,cid,arr,search){
	...
	$.ajax({
	 	type: "POST",
		data : {search:search},
		url: base_url + "index.php/home_user/quiz_assign_1/"+page +"/"+ uidz +"/"+ cid +"/"+ arr ,
		success: function(results){
			// console.log(results);
			...
			var html='<br><div><div class="col-sm-3" style="margin-top:5px"><select style="width:120px" onchange="redraw_assign_quiz(this,'+cid+','+arr+',\''+search+'\')"><option value="0">';
			if(su!=2){
				html += 'Học sinh';
			}
			else{
			...
			for(i=0; i<results.assign.student.length; i++){
			 ...
			 html += '<div class="col-sm-3" style="margin-top:5px"><select style="width:120px" onchange="redraw2_assign_quiz(this,'+uidz+','+arr+',\''+search+'\')">';
			 ...
			 html += '</select></div>';
			 html += '<div class="col-sm-3" style="margin-top:5px"><select style="width:120px"  onchange="redraw3_assign_quiz(this,'+uidz+','+cid+',\''+search+'\')" >';
			 ...
			 html += '</select></div>';			 
			 html += '<div class="col-sm-3" style="margin-top:5px"><input style="width:120px" id="search_assign_quiz1" value= "'+search+'" onkeyup="redrawsearch_assign_quiz(this,event,'+uidz+','+cid+','+arr+')"></input>';
			 html += '<span><i class="pointer fas fa-search" onclick="redrawsearch_assign_quiz1('+page+','+uidz+','+cid+','+arr+',\''+search+'\')"></i></span></div>';
			...
			if(results.assign.quiz.length > 0){
			    for (var i = results.assign.quiz.length-1; i >=0; i--) {
			    	var html = '<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" id="card' + results.assign.quiz[i].id + '">';
					...
					html += '<i class="color-blue far fa-user"></i> Người giao: <span class="text-strong">' + results.assign.quiz[i].aname +'</span>';
					// html += '<br> <i class="fa fa-user-circle"></i> Học sinh: <br>' + results.assign.quiz[i].first_name ;
					var startdate = new Date(results.assign.quiz[i].startdate.replace(' ', 'T'));
					var dateshow = startdate.getDate()+'-'+(startdate.getMonth() + 1)+'-'+startdate.getFullYear(); 
					html += '<br><i class="color-blue fas fa-clock"></i> Ngày bắt đầu: <span class="text-strong">' + dateshow + '</span>';
					...
					if(results.assign.quiz[i].sta == 1){
						...
						html+='<i class="color-blue fas fa-trophy"></i> Thưởng tối đa: <span class="text-strong">'+ results.assign.quiz[i].reward_point +' </span>';
			    	}else{
						
			    		html+='<i class="color-blue fas fa-address-book"></i> Loại bài: <span class="text-strong">'+ loai_bai +'</span><br>';
						html+='<i class="color-blue fas fa-chart-bar"></i> Kết quả: <span class="text-strong">'+ Math.round(results.assign.quiz[i].percentage_obtained) +'% </span><br>';
						html+='<i class="color-blue fas fa-trophy"></i> Thưởng: <span class="text-strong">'+ Math.round((results.assign.quiz[i].percentage_obtained * results.assign.quiz[i].reward_point)/100) +' điểm</span><br>';
						html+='<i class="color-blue fas fa-star"></i> Tổng điểm: <span class="text-strong">';
							if(results.assign.quiz[i].point_remain!=null){
								html+=results.assign.quiz[i].point_remain;
							}else{
								html+='0';
							}
						html+=' điểm</span>';
					...
					if(results.user.quiz.includes("Assign")){
						if(results.assign.quiz[i].sta == 1){
							html += '<a href="#" onclick="send_reminders(' + results.assign.quiz[i].id + ')" title=""><button class="btn btn-danger">Nhắc nhở</button></a>&nbsp;';
							html += '<a href="#" onclick="delete_assign(' + results.assign.quiz[i].id + ',' + results.assign.quiz[i].quid + ','+ results.assign.quiz[i].auid +','+ results.assign.quiz[i].uid +');quizAssignTo_1('+page+','+uidz+','+cid+','+arr+',\''+search+'\')"><button class="btn btn-default">Hủy</button></a>';
						}else{
							html += '<a href="'+base_url+'index.php/result/view_result/'+ results.assign.quiz[i].rid +'"><button class="btn btn-success">Xem kết quả</button></a>';	
						}
